...
abstract class BaseSharedPreferences {
  ...
  fun stringPref(prefKey: String? = null, defaultValue: String? = null) = StringPrefDelegate(
      prefKey, defaultValue)

  inner class StringPrefDelegate(
      prefKey: String? = null,
  ...
  //Int Delegate
  fun intPref(prefKey: String? = null, defaultValue: Int = 0) = IntPrefDelegate(prefKey,
      defaultValue)

  inner class IntPrefDelegate(
      prefKey: String? = null,
...
//Float Delegate
  fun floatPref(prefKey: String? = null, defaultValue: Float = 0f) = FloatPrefDelegate(prefKey,
      defaultValue)

  inner class FloatPrefDelegate(
      prefKey: String? = null,
...
//Boolean Delegate
  ...
  inner class BooleanPrefDelegate(
      prefKey: String? = null,
...
//Long Delegate
  ...
  inner class LongPrefDelegate(prefKey: String? = null,
      private val defaultValue: Long) : PrefDelegate<Long>(prefKey) {
    override fun getValue(thisRef: Any?, property: KProperty<*>) =
  ...
  //String Set Delegate
  fun stringSetPref(prefKey: String? = null,
      defaultValue: Set<String> = HashSet()) = StringSetPrefDelegate(prefKey, defaultValue)

  inner class StringSetPrefDelegate(prefKey: String? = null,
      private val defaultValue: Set<String>) : PrefDelegate<Set<String>>(prefKey) {
